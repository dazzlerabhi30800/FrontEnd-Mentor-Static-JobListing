...
function JobListComp({
    ...
    return(
       <div className={`flex flex-col gap-4 py-2 px-4 my-10 md:my-6 bg-teal-50 shadow-lg mx-auto w-96 ${featured && 'border-l-4 border-teal-500 border-solid' } md:flex-row md:w-9/12`}>
